...
if(isset($_POST['fechaPrestamo']) && isset($_POST['libro']) && isset($_POST['usuario'])){
    ...
    if ($response === false) {
        ...
        echo 'Préstamo creado correctamente';
    }
    ...
    echo "No se recibieron todos los datos necesarios para crear el préstamo";
}
